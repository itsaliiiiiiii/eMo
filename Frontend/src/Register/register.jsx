...
const RegisterForm = () => {
    ...
    return (
        <>
            ...
            <Routes>
                <Route path="/name" element={<Name updateFormData={updateFormData} />} />
                <Route path="/mailpassword" element={<MailPassword updateFormData={updateFormData} />} />
                <Route path="/phone" element={<Phone formData={formData} updateFormData={updateFormData} />} />
            </Routes>
        </>
    );
};
